...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_cours'])) {
    ...
    $coursController->deleteCours($coursId);
    // Redirect to refresh the page after deletion
    header("Location: cours-datatable.php");
    exit();
}

// Handle chapter delete action
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_chapitre'])) {
    $chapitreId = $_POST['id_chapitre'];
    $chapitreController->deleteChapitre($chapitreId);
    // Redirect to refresh the page after deletion
    header("Location: cours-datatable.php");
    exit();
}
...
// Fetch chapter list
$chapitreList = $chapitreController->getAllChapitres();

// Prepare course titles for chapters
$courseTitles = [];
foreach ($coursList as $cours) {
    $courseTitles[$cours['id_cours']] = $cours['titre'];
}
?>
    ...
    <ul class="navbar-nav gap-1 nav-right-links align-items-center">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
          ...
          <hr class="dropdown-divider">
          <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="../Front_Office/logout.php"><i
  ...
  <div class="sidebar-nav">
      ...
      <ul class="metismenu" id="sidenav">
        ...
        <!--<li>
          ...
          <li>
            ...
            <ul>
              ...
              <!--<li><a href="ecommerce-customer-details.html"><i class="material-icons-outlined">arrow_right</i>users Details</a>
              </li>
        ...
        <li>
          ...
          <ul>
            <li><a href="Cours-datatable.php"><i class="material-icons-outlined">arrow_right</i>courses</a>
            </li>
            ...
            <li><a href="course-datatable.html"><i class="material-icons-outlined">arrow_right</i>user</a>
            </li>
...
<!--end sidebar-->
  ...
  <main class="main-wrapper">
    <div class="main-content">
        ...
        <div class="ms-auto">
          <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
              <a class="dropdown-item" href="create_cours.php"><i class="bx bx-plus"></i> Ajouter Course</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="create_chapitre.php"><i class="bx bx-plus"></i> Ajouter Chapitre</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <h6 class="mb-0 text-uppercase">Courses Data Table</h6>
      <hr>
      <div class="card">
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table id="example2" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php if (!empty($coursList)) : ?>
                        ...
                        <tr>
                            <td><?= htmlspecialchars($cours['id_cours']) ?></td>
                            <td><?= htmlspecialchars($cours['titre']) ?></td>
                            <td><?= htmlspecialchars($cours['description']) ?></td>
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="edit_cours.php?id=<?= $cours['id_cours'] ?>" 
                                    class="btn btn-sm btn-primary"
                                    title="Edit">
                                    <i class="bx bx-edit"></i>
                                    </a>
                                    <form method="POST" action="cours-datatable.php" class="d-inline">
            ...
            <!-- Chapters Table (new) -->
            <table id="chaptersTable" class="table table-striped table-bordered mt-4">
                <thead>
                    <tr>
                        <th>ID Chapitre</th>
                        <th>Titre</th>
                ...
                <tbody>
                    <?php if (!empty($chapitreList)) : ?>
                        <?php foreach ($chapitreList as $chapitre) : 
                            $coursTitle = $courseTitles[$chapitre['id_cours']] ?? 'Unknown Course';
                            $truncatedContent = htmlspecialchars(substr($chapitre['contenu'], 0, 50));
                            $fullContent = htmlspecialchars($chapitre['contenu']);
                        ?>
                        <tr>
                            <td><?= htmlspecialchars($chapitre['id_chapitre']) ?></td>
                            <td><?= htmlspecialchars($chapitre['titre']) ?></td>
                            <td>
                                <a href="#" class="content-link" 
                                   data-bs-toggle="modal" 
                                   data-bs-target="#contentModal"
                                   data-content="<?= $fullContent ?>"
                                   data-title="<?= htmlspecialchars($chapitre['titre']) ?>">
                                    <?= $truncatedContent ?>...
                                </a>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="edit_chapitre.php?id=<?= $chapitre['id_chapitre'] ?>" 
                                    class="btn btn-sm btn-primary"
                                    title="Edit">
                                    <i class="bx bx-edit"></i>
                                    </a>
                                    <form method="POST" action="cours-datatable.php" class="d-inline">
                                    <input type="hidden" name="id_chapitre" value="<?= $chapitre['id_chapitre'] ?>">
                                    <button type="submit" 
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5" class="text-center py-4">No chapters found</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 id="modalChapterTitle" class="mb-3"></h6>
                <div id="modalChapterContent" class="border p-3" style="white-space: pre-wrap; max-height: 400px; overflow-y: auto;"></div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalContent = document.getElementById('modalChapterContent');
