...
$events = $model->getAllEvents(); // Cette méthode est bien définie dans EventModel
...
<!--end sidebar-->
  ...
  <!--start main wrapper-->
  <?php
// EventView.php (adjust according to your view folder)
...
<main class="main-wrapper">
    ...
    <?php if (empty($events)): ?>
    <p style='color: red;'>Erreur : La liste des événements n'est pas chargée.</p>
<?php else: ?>
    <h6 class="mb-0 text-uppercase">DataTable Import</h6>
    <hr>
    <a href="http://localhost/projet%20web/View/Back_Office/add_event.php" class="btn btn-success mb-3">Ajouter un événement</a>
  ...
  <?php if (!empty($events)): ?>
    <?php foreach ($events as $event): ?>
        <tr>
            ...
            <td>
                <a href="edit_event.php?id=<?php echo $event->getIdEvent(); ?>" class="btn btn-primary btn-sm">Edit</a>
                <a href="delete_event.php?id=<?php echo $event->getIdEvent(); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
            </td>

        </tr>
    <?php endforeach; ?>
  <?php else: ?>
    <tr><td colspan="7">Aucun événement disponible.</td></tr>
  <?php endif; ?>
</tbody>
