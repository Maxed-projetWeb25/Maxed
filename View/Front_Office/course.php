...
<head>
<meta charset="utf-8">
<title>Braine Digital Agency Business HTML-5 Template | Team</title>
<!-- Stylesheets -->
                    ...
                    <div class="team-block_one col-lg-4 col-md-6 col-sm-12">
                        <div class="team-block_one-inner">
                            <div class="team-block_one-image">
                                <!-- Placeholder image - you can replace with course image from database later -->
                                <img src="assets/images/resource/team-1.jpg" alt="<?= htmlspecialchars($course['titre']) ?>" />
                            </div>
                            <div class="team-block_one-content">
                                <!-- Course Title (titre) -->
                                <h4 class="team-block_one-title"><?= htmlspecialchars($course['titre']) ?></h4>
                                ...
                                <div class="team-block_one-socials">
                                    <a href="course-details.php?id=<?= $course['id_cours'] ?>" class="template-btn btn-style-two">
                                        <span class="btn-wrap">
                                            <span class="text-one">Voir chapitres</span>
                                            <span class="text-two">Voir chapitres</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
