    ...
    <div class="sidebar-nav">
      <ul class="metismenu" id="sidenav">
        ...
        <li>
          ...
          <ul>
            <li><a href="add-event.php"><i class="material-icons-outlined">arrow_right</i>Add Event</a></li>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Ticket Management</div>
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a></li>
              <li class="breadcrumb-item active" aria-current="page"><?php echo $pageTitle ?? 'Tickets'; ?></li>
            </ol>
          </nav>
        </div>
      </div>
