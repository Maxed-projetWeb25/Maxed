    ...
    <div class="sidebar-nav">
      <ul class="metismenu" id="sidenav">
        <li>
          ...
          <ul>
            <li><a href="statistics.php"><i class="material-icons-outlined">arrow_right</i>Analysis</a></li>
          </ul>
        </li>
        <li>
          <a href="javascript:;" class="has-arrow">
          ...
          <ul>
            <li><a href="add-event.html"><i class="material-icons-outlined">arrow_right</i>Add Event</a></li>
            <li><a href="event-datatable.php"><i class="material-icons-outlined">arrow_right</i>Event List</a></li>
            <li><a href="addTicket.php"><i class="material-icons-outlined">arrow_right</i>Add Ticket</a></li>
          </ul>
        </li>
      </ul>
    </div>
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page"><?php echo $pageTitle ?? 'Events'; ?></li>
            </ol>
          </nav>
        </div>
      </div>
                ...
                <?php 
                    if (isset($content)) {
                        try {
                            ...
                            echo '<div class="alert alert-danger">An error occurred while loading the content.</div>';
                        }
                    }
                ?>
            </div>
