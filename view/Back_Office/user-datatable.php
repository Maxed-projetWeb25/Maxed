...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_user'])) {
    ...
    $utilisateurC->deleteUser($userId);
    // Redirect to refresh the page after deletion
    header("Location: user-datatable.php");
    exit();
}

// Fetch users
$utilisateurC = new UtilisateurC();
$users = $utilisateurC->listUsers();
  ...
  <div class="sidebar-nav">
      ...
      <ul class="metismenu" id="sidenav">
        ...
        <li>
          ...
          <ul>
            <li><a href="user-datatable.php"><i class="material-icons-outlined">arrow_right</i>user</a>
            </li>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      <!--breadcrumb-->
				...
				<h6 class="mb-0 text-uppercase">Users Data Table</h6>
				<hr>
				<div class="card">
					<div class="card-body">
								...
								<tbody>
									...
									if ($users) {
										foreach ($users as $user) {
											...
											echo "<button type='submit' name='delete_user' class='btn btn-danger btn-sm'><i class='material-icons-outlined'>delete</i></button>";
											echo "</form>";
											// Update link
											echo " <a href='update-user.php?id=" . htmlspecialchars($user['id']) . "' class='btn btn-primary btn-sm'><i class='material-icons-outlined'>edit</i></a>";
											echo "</td>";
											echo "</tr>";
										}
									} else {
