...
$userData = $utilisateurC->showUser($userId);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_user'])) {
    ...
    $user = new Utilisateur($nom, $prenom, $age, $tel, $role, $email, $pwd);
    // Update the user
    try {
        $utilisateurC->updateUser($user, $userId);
        header("Location: user-datatable.php");
        exit();
    } catch (Exception $e) {
...
<head>
  ...
  <title>Maxton | Update User</title>
  <!--favicon-->
...
<main class="main-wrapper">
  <div class="main-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      ...
      <div class="ms-auto">
        <div class="btn-group">
          <a href="user-datatable.php" class="btn btn-primary">Back to Users</a>
        </div>
      </div>
    </div>
    <!--end breadcrumb-->
      ...
      <div class="card-body">
        ...
        <form method="POST" action="">
          <div class="mb-3">
            ...
            <input readonly type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($userData['email']); ?>" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3" hidden>
            ...
            <input type="password" class="form-control" id="pwd" name="pwd" value="<?php echo htmlspecialchars($userData['pwd']); ?>" required>
          </div>
