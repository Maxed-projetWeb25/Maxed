...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['user_email'])) {
    header("location:../Front_Office/auth-boxed-login.php");
    exit();
}
?>
...
<div class="page-wrapper">
						...
						<div class="outer-box d-flex align-items-center flex-wrap">
							...
							<div class="language-dropdown">
								...
								<?php if (isset($_SESSION['user_id'])): ?>
									...
									<span class="user-name" style="color: #fff; margin-right: 15px;">
										Welcome, <?php echo htmlspecialchars($_SESSION['user_nom']); ?>!
									</span>
									<a href="logout.php" class="template-btn btn-style-two">
										<span class="btn-wrap">
								...
								<?php else: ?>
									<!-- User is not logged in: Show Login and Join now buttons -->
									<a href="auth-boxed-login.php" class="template-btn btn-style-two">
										<span class="btn-wrap">
											<span class="text-one">Login</span>
											<span class="text-two">Login</span>
										</span>
									</a>
									<a href="view/Front_Office/auth-boxed-register.php" class="template-btn btn-style-one">
										<span class="btn-wrap">
					...
					<div class="auto-container">
						<div class="row clearfix">
							...
							<div class="slider-one_content col-lg-7 col-md-12 col-sm-12">
								<div class="slider-one_content-inner">
									<div class="slider-one_title"><i><img src="assets/images/main-slider/hand.png" alt="" /></i> AI makes content fast & easy</div>
									<h1 class="slider-one_heading">Join a community of entrepreneurs, investors, and students . <span> </span> </h1>
							...
							<div class="slider-one_image-column col-lg-5 col-md-12 col-sm-12">
								...
								<div class="slider-one_image-outer">
									...
									<div class="slider-one_image">
										<img src="assets/images/main-slider/mirror.png" alt="" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="auto-container">
						<div class="row clearfix">
							...
							<div class="slider-one_content col-lg-7 col-md-12 col-sm-12">
								<div class="slider-one_content-inner">
									<div class="slider-one_title"><i><img src="assets/images/main-slider/hand.png" alt="" /></i> AI makes content fast & easy</div>
									<h1 class="slider-one_heading"> <span></span>Take online courses and test your skills with interactive quizzes.</h1>
			...
			<div class="row clearfix">
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.html">Events</a></h5>
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.html">Feeds</a></h5>
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.html">Quiz</a></h5>
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.html">courses</a></h5>
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.html">report</a></h5>
						<div class="service-block_one-text"><span> Utilize our dedicated complaint service to report any issues, ensuring prompt and effective resolution.. </span>   ..</div>
						<div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
			...
			<div class="row clearfix">
				...
				<div class="about-one_content-column col-xl-6 col-lg-6 col-md-12 col-sm-12">
					<div class="about-one_content-outer">
						...
						<p>At our platform,<span> entrepreneurs, investors, and students</span> swe empower by combining expert-led courses, live pitch events, and a collaborative community to fuel innovation and drive success.</p>
						<p></p>
					...
					<div class="column col-lg-6 col-md-12 col-sm-12">
						...
						<div class="step-block_one">
							<div class="step-block_one-inner">
								...
								<div class="step-block_one-text">plore e-learning courses, take quizzes, and get ready to pitch or invest.</div>
								<div class="step-block_one-content">
									<div class="image">
										...
										<div class="price-block_one-inner">
											...
											<div class="price-block_one-content">
												...
												<ul class="price-block_one-list">
													...
													<li><i class="fa-solid fa-check fa-fw"></i>Email support only</li>
													<li><i class="fa-solid fa-check fa-fw"></i>Join community discussions
										...
										<div class="price-block_one-inner">
											...
											<div class="price-block_one-content">
												...
												<ul class="price-block_one-list">
													...
													<li><i class="fa-solid fa-check fa-fw"></i>Access to advanced analytics & startup reports</li>
													<li><i class="fa-solid fa-check fa-fw"></i>Exclusive invitations to premium events</li>
												</ul>
											</div>
										</div>
									</div>
						...
						<ul class="accordion-box_two">
							...
							<li class="accordion block">
								...
								<div class="acc-content">
									<div class="content">
										<div class="text">Our platform connects entrepreneurs, investors, and students in one dynamic space where they can pitch ideas, learn new skills, and collaborate on innovative projects.
										</div>
									</div>
								</div>
							</li>
							...
							<li class="accordion block">
								...
								<div class="acc-content">
									<div class="content">
										<div class="text">Simply create an entrepreneur account, complete your profile, and register for upcoming pitch events. You’ll receive a schedule and a link to join the live session.</div>
									</div>
								</div>
							</li>
							...
							<li class="accordion block">
								...
								<div class="acc-content">
									<div class="content">
										<div class="text">We offer a mix of free and premium courses. You can start with basic content under the Starter Plan, then upgrade to access full e-learning materials and quizzes.
										</div>
									</div>
								</div>
							</li>
							...
							<li class="accordion block">
								...
								<div class="acc-content">
									<div class="content">
										<div class="text">Yes, investors with an active subscription can view profiles and pitch decks, and initiate conversations with entrepreneurs through our messaging system.										</div>
									</div>
								</div>
							</li>
							...
							<!-- Block -->
							<li class="accordion block">
								<div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa-solid fa-plus fa-fw"></span></div>Do I need experience to join?</div>
								<div class="acc-content">
									<div class="content">
										<div class="text">Not at all! Whether you're a beginner or a seasoned professional, our platform is designed to support and guide you at every stage of your journey.
	...
	<section class="news-one">
		...
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title title-anim centered">
				<div class="sec-title_title">our courses</div>
				<h2 class="sec-title_heading">join our latest <span>courses</span></h2>
			</div>
			<div class="three-item_carousel swiper-container">
				<div class="swiper-wrapper">
						...
						<div class="news-block_one">
							<div class="news-block_one-inner">
								...
								<div class="news-block_one-content">
									<h5 class="news-block_one-title"><a href="feed.html">Transforming industries and shaping the future</a></h5>
					...
					<div class="swiper-slide">
						...
						<div class="news-block_one">
							<div class="news-block_one-inner">
								...
								<div class="news-block_one-content">
									<h5 class="news-block_one-title"><a href="feed.html">Exploring the cutting-edge of artificial intelligence</a></h5>
									<div  class="news-block_one-text">Lorem ipsum dolor sit amet consectetur adipiscing vitae mattis tellus. Nullam quis mattis ligula consectetur.</div>
									<div class="news-block_one-button">
										<a href="blog.html" class="template-btn btn-style-two">
											<span class="btn-wrap">
					...
					<div class="swiper-slide">
						...
						<div class="news-block_one">
							<div class="news-block_one-inner">
								...
								<div class="news-block_one-content">
									<h5 class="news-block_one-title"><a href="feed.html">Understanding the basics of artificial intelligence</a></h5>
									<div  class="news-block_one-text">Lorem ipsum dolor sit amet consectetur adipiscing vitae mattis tellus. Nullam quis mattis ligula consectetur.</div>
									<div class="news-block_one-button">
										<a href="blog.html" class="template-btn btn-style-two">
											<span class="btn-wrap">
				...
				<div class="row clearfix">
					...
					<div class="cta-one_title-column col-lg-6 col-md-12 col-sm-12">
						<div class="cta-one_title-outer">
							<h2 class="cta-one_title">Craft your great <span> future</span></h2>
